...
$(function() {
    ...
    describe('The menu', function() {
         ...
         */
        it('should have the menu hidden', function() {
            var menuValue = $('body').hasClass('menu-hidden');
            expect(menuValue).toBe(true);
        });
         ...
         */
        it('should hide the menu on click', function() {
